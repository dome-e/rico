...
"""autogenerated by genpy from rosplan_tiago_scenarios_msgs/LeaveLoadActionResult.msg. Do not edit."""
import codecs
import sys
...
class LeaveLoadActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "rosplan_tiago_scenarios_msgs/LeaveLoadActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rosplan_tiago_scenarios_msgs/LeaveLoadResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LeaveLoadActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rosplan_tiago_scenarios_msgs.msg.LeaveLoadResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rosplan_tiago_scenarios_msgs.msg.LeaveLoadResult()
