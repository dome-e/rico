...
"""autogenerated by genpy from rosplan_tiago_scenarios_msgs/GetLoadActionResult.msg. Do not edit."""
import codecs
import sys
...
class GetLoadActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "rosplan_tiago_scenarios_msgs/GetLoadActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rosplan_tiago_scenarios_msgs/GetLoadResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetLoadActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = rosplan_tiago_scenarios_msgs.msg.GetLoadResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = rosplan_tiago_scenarios_msgs.msg.GetLoadResult()
