...
"""autogenerated by genpy from rosplan_tiago_scenarios_msgs/GoScanningActionGoal.msg. Do not edit."""
import codecs
import sys
...
class GoScanningActionGoal(genpy.Message):
  _md5sum = "83a5003608bfe9186a54ce300336432e"
  _type = "rosplan_tiago_scenarios_msgs/GoScanningActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','rosplan_tiago_scenarios_msgs/GoScanningGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoScanningActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = rosplan_tiago_scenarios_msgs.msg.GoScanningGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = rosplan_tiago_scenarios_msgs.msg.GoScanningGoal()
