...
"""autogenerated by genpy from rosplan_tiago_scenarios_msgs/GoActionGoal.msg. Do not edit."""
import codecs
import sys
...
class GoActionGoal(genpy.Message):
  _md5sum = "83a5003608bfe9186a54ce300336432e"
  _type = "rosplan_tiago_scenarios_msgs/GoActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','rosplan_tiago_scenarios_msgs/GoGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = rosplan_tiago_scenarios_msgs.msg.GoGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = rosplan_tiago_scenarios_msgs.msg.GoGoal()
