...
"""autogenerated by genpy from rosplan_tiago_scenarios_msgs/GoActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class GoActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "rosplan_tiago_scenarios_msgs/GoActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rosplan_tiago_scenarios_msgs/GoFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = rosplan_tiago_scenarios_msgs.msg.GoFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = rosplan_tiago_scenarios_msgs.msg.GoFeedback()
