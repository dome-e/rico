...
class GetLoadActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GetLoadFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GetLoadFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GetLoadActionFeedback(null);
    ...
    data.feedback = GetLoadFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetLoadActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GetLoadFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GetLoadFeedback()
    }
...
module.exports = GetLoadActionFeedback;
