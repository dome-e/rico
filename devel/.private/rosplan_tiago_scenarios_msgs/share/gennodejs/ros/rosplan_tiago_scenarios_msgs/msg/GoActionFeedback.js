...
class GoActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GoFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GoActionFeedback(null);
    ...
    data.feedback = GoFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GoActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GoFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GoFeedback()
    }
...
module.exports = GoActionFeedback;
