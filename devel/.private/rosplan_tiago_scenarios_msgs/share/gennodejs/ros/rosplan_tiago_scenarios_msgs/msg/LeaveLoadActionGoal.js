...
class LeaveLoadActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LeaveLoadGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += LeaveLoadGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LeaveLoadActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LeaveLoadGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LeaveLoadGoal()
    }
...
module.exports = LeaveLoadActionGoal;
