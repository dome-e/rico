...
class LeaveLoadActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new LeaveLoadFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LeaveLoadFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LeaveLoadActionFeedback(null);
    ...
    data.feedback = LeaveLoadFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LeaveLoadActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = LeaveLoadFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new LeaveLoadFeedback()
    }
...
module.exports = LeaveLoadActionFeedback;
