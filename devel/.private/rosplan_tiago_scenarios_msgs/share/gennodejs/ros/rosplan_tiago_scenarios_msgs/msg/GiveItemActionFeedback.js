...
class GiveItemActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GiveItemFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GiveItemFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GiveItemActionFeedback(null);
    ...
    data.feedback = GiveItemFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GiveItemActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GiveItemFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GiveItemFeedback()
    }
...
module.exports = GiveItemActionFeedback;
