...
class GoWithAttendanceActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new GoWithAttendanceFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GoWithAttendanceFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GoWithAttendanceActionFeedback(null);
    ...
    data.feedback = GoWithAttendanceFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GoWithAttendanceActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GoWithAttendanceFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GoWithAttendanceFeedback()
    }
...
module.exports = GoWithAttendanceActionFeedback;
