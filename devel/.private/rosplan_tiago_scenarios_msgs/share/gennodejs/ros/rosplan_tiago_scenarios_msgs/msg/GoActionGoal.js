...
class GoActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GoGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GoActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GoGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GoGoal()
    }
