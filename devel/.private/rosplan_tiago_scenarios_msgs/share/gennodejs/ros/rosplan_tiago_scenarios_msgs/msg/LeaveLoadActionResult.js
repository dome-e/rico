...
class LeaveLoadActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new LeaveLoadResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LeaveLoadResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LeaveLoadActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = LeaveLoadResult.Resolve(msg.result)
    }
    else {
      resolved.result = new LeaveLoadResult()
    }
...
module.exports = LeaveLoadActionResult;
