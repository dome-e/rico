...
class GreetFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int16(obj.percent_complete, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GreetFeedback(null);
    // Deserialize message field [percent_complete]
    data.percent_complete = _deserializer.int16(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GreetFeedback(null);
