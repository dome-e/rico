...
"""autogenerated by genpy from tiago_msgs/SaySentenceAction.msg. Do not edit."""
import codecs
import sys
...
class SaySentenceAction(genpy.Message):
  _md5sum = "14592eeefb6e6a3145d19dc692f68475"
  _type = "tiago_msgs/SaySentenceAction"
...
"""
  ...
  _slot_types = ['tiago_msgs/SaySentenceActionGoal','tiago_msgs/SaySentenceActionResult','tiago_msgs/SaySentenceActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SaySentenceAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = tiago_msgs.msg.SaySentenceActionGoal()
      if self.action_result is None:
        self.action_result = tiago_msgs.msg.SaySentenceActionResult()
      if self.action_feedback is None:
        self.action_feedback = tiago_msgs.msg.SaySentenceActionFeedback()
    else:
      self.action_goal = tiago_msgs.msg.SaySentenceActionGoal()
      self.action_result = tiago_msgs.msg.SaySentenceActionResult()
      self.action_feedback = tiago_msgs.msg.SaySentenceActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.sentence
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.sentence = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.sentence = str[start:end]
      _x = self
      start = end
      end += 12
