...
"""autogenerated by genpy from tiago_msgs/SaySentenceActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class SaySentenceActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "tiago_msgs/SaySentenceActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tiago_msgs/SaySentenceFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SaySentenceActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = tiago_msgs.msg.SaySentenceFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = tiago_msgs.msg.SaySentenceFeedback()
