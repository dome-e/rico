...
"""autogenerated by genpy from tiago_msgs/SaySentenceActionResult.msg. Do not edit."""
import codecs
import sys
...
class SaySentenceActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "tiago_msgs/SaySentenceActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tiago_msgs/SaySentenceResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SaySentenceActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tiago_msgs.msg.SaySentenceResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tiago_msgs.msg.SaySentenceResult()
