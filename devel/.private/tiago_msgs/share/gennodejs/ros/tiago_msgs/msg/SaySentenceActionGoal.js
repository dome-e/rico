...
class SaySentenceActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SaySentenceGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SaySentenceGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SaySentenceActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SaySentenceGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SaySentenceGoal()
    }
...
module.exports = SaySentenceActionGoal;
