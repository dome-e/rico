...
class NonBlockingDispatchAction(genpy.Message):
  _md5sum = "792b77b7f9a3d73da6f37e4232b708e5"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.feedback.action_id
      buff.write(_get_struct_i().pack(_x))
      _x = self.action_feedback.feedback.feedback.status
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_feedback.feedback.feedback.action_id,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_feedback.feedback.feedback.status = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.feedback.status = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
