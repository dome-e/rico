        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    audio_path = "/home/dominika/tiago_public_ws/src/ros/dialogflow/output_file.wav"
                    # print("went into try")
                    # print("slayy")
                    audio = self.read_file(audio_path, porcupine.sample_rate)
...
def main():
    ...
    parser.add_argument('--model_file_path',          help='absolute path to model parameter file', default=MODEL_PATH)
